...
parser.add_argument('--hidden_size', type=int, default=256, metavar='N',
                    help='network size (net_size) for Actor and Critic (default: 256)')
...
agent = DDPG(env.observation_space.shape[0], env.action_space.shape[0], env.action_space, args)
LOG_DIR = '{}/{}_DDPG_{}'.format(args.dir, datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S"), args.env)
